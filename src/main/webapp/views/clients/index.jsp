...
<body data-bs-spy="scroll" data-bs-target="#navbar"
						...
						<div class="row d-flex align-items-center">
							<div class="col-md-6">
								<div class="banner-content">
									<h1 class="display-2 text-uppercase text-dark pb-5">Apple
										Iphone for Life</h1>
									<a href="shop.html"
							...
							<div class="col-md-5">
								<div class="image-holder">
									<img
										src="/ProjectShop/views/clients/assets/images/banner-image.png"
										alt="banner">
								</div>
							</div>
						</div>
				...
				<div class="swiper-slide">
					<div class="container">
						<div class="row d-flex flex-wrap align-items-center">
							<div class="col-md-6">
								<div class="banner-content">
									<h1 class="display-2 text-uppercase text-dark pb-5">For
										more watches</h1>
									<a href="shop.html"
										class="btn btn-medium btn-dark text-uppercase btn-rounded-none">Shop
										Product</a>
		...
		<div class="container">
			...
			<div class="row">
				<div class="display-header d-flex justify-content-between pb-3">
					<h2 class="display-7 text-dark text-uppercase">Iphone Products</h2>
				...
				<div class="swiper product-swiper">
					...
					<div class="swiper-wrapper">
						<c:forEach items="${requestScope.list1}" var="sp">
							<div class="swiper-slide">
	...
	<!--   Speaker SECTION -->
	<section id="speaker-products"
		class="product-store position-relative padding-large">
		<div class="container">

			<div class="row">
				<div class="display-header d-flex justify-content-between pb-3">
					<h2 class="display-7 text-dark text-uppercase">Speaker
						Products</h2>
				</div>
				...
				<div class="swiper product-swiper">
					...
					<div class="swiper-wrapper">
						<c:forEach items="${requestScope.list2}" var="sp">
							<div class="swiper-slide">
								<div class="product-card position-relative">
									<div class="image-holder">
										<a href="/ProjectShop/home?page=detail&id=${sp.id}"> <img
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="swiper product-swiper">
					...
					<div class="swiper-wrapper">
						<c:forEach items="${requestScope.list3}" var="sp">
							<div class="swiper-slide">
								<div class="product-card position-relative">
									<div class="image-holder">
										<a href="/ProjectShop/home?page=detail&id=${sp.id}"> <img
