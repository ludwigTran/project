...
if (session.getAttribute("usernameClient") == null) {
	response.sendRedirect("/ProjectShop/views/clients/loginClient.jsp");
}
%>
...
<header id="header"
	...
	<%-- <c:set value="${requestScope.cl }" var="client"></c:set> --%>
	<nav id="header-nav" class="navbar navbar-expand-lg px-3 mb-3">
		<div class="container-fluid">
			<a class="navbar-brand" href="/ProjectShop/home"> <img
				src="/ProjectShop/views/clients/assets/images/main-logo.png"
				class="logo">
			</a>
				...
				<div class="offcanvas-body">
					<ul id="navbar"
						...
						<li class="nav-item"><a class="nav-link me-4 active"
							href="/ProjectShop/home#billboard">Home</a></li>
						<li class="nav-item"><a class="nav-link me-4"
							href="/ProjectShop/home#company-services">Services</a></li>
						<li class="nav-item"><a class="nav-link me-4"
							href="/ProjectShop/home#mobile-products">Iphone</a></li>
						<li class="nav-item"><a class="nav-link me-4"
							href="/ProjectShop/home#speaker-products">Speaker</a></li>
						<li class="nav-item"><a class="nav-link me-4"
							href="/ProjectShop/home#smart-watches">Watches</a></li>
						<li class="nav-item"><a class="nav-link me-4"
							href="/ProjectShop/home#yearly-sale">Sales Off</a></li>
						<li class="nav-item"><a class="nav-link me-4"
							href="/ProjectShop/home#latest-blog">Blog</a></li>

						<li class="nav-item"><a class="nav-link me-4"
							href="/ProjectShop/home?page=clientInfo">Hi,
								${sessionScope.client.getFullname()}</a></li>
						<li class="nav-item"><a class="nav-link me-4"
							href="/ProjectShop/home?page=logout">Logout</a></li>
						<li>
							<div class="user-items ps-5">
								<ul class="d-flex justify-content-end list-unstyled">
									<li class="search-item pe-3">
										<form class="d-flex" role="search" method="get" action="/ProjectShop/search">
									...
									<li><a href="/ProjectShop/cartsymbol"
										class="position-relative"> <svg class="cart">
			                            <use xlink:href="#cart"></use>
										 	<c:set var="x" value="0"></c:set>
											<c:forEach items="${cartID }" var="i">
												<c:set var="x" value="${x+1 }"></c:set>
											</c:forEach>                
			  							<span class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger"
										style="font-size: 9px; top: -5px !important">
									    	<c:out value="${x}"></c:out>
									  	</span>                        
			                          </svg>
									</a></li>
